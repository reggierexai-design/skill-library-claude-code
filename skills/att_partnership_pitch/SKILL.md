...
## Avoid when
- Do not use when the partnership idea only benefits one side.
...
## Operating rules
- Mutual value must be concrete, not implied.
- Pitch the smallest viable collaboration first.
- Respect the partner's audience and incentives.
...
## Expanded workflow
1. Define the partner fit and joint value.
2. Choose the right initial collaboration shape.
3. Write the pitch and follow-up note.
4. Return next steps and likely objections.
...
- Natural language: "Use partnership Pitch to create a partnership angle, value exchange, and outreach package that feels mutually useful."
...
## Quality bar
- A partnership pitch works when the other side sees upside quickly.
