...
## Avoid when
- Do not use when the list quality and audience fit are still unknown.
...
## Operating rules
- Make the message about the recipient's context, not your excitement alone.
- Lead with relevance, value, or an honest reason for contact.
...
## Expanded workflow
1. Define the audience segment and desired reply.
2. Write the opener, follow-up, and close.
3. Tighten for clarity and respect.
4. Return variants by audience if needed.
...
- Natural language: "Use outbound Sequences to write founder-led or team outbound messages that earn replies without spammy patterns."
...
## Quality bar
- Good outbound feels welcome, not tolerated.
