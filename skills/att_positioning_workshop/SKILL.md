...
## Purpose
- Define who the project is for, what pain it solves, why it wins, and why now.
...
## Avoid when
- Do not use when the user only needs a final copy draft from an already-solid positioning strategy.
...
## Operating rules
- Positioning is about exclusion as much as inclusion.
- Frame the enemy, the wedge, and the proof.
- Avoid category clichés and generic founder language.
...
## Expanded workflow
1. Define the audience, pain, alternatives, and timing.
2. Identify the strongest wedge and proof.
3. Draft the positioning statement and category frame.
4. Test it against likely confusion points.
...
- Primary positioning
- Proof and anti-confusion notes
...
- Natural language: "Use positioning Workshop to define who the project is for, what pain it solves, why it wins, and why now."
...
## Quality bar
- Positioning is done when the right people immediately feel seen.
