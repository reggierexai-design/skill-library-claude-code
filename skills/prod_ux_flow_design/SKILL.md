...
- UX flow design: screens, transitions, decision points, error paths, success paths.
- Edge case handling for each flow step.
- Handoff to engineering: interaction specs and state definitions.
