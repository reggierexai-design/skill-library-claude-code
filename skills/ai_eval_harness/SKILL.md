...
## Purpose
- Design test cases and score rules that catch regressions in agent quality and safety.
- This is an **AI specialist** for Claude Code users who need a result that can survive review, handoff, or execution.
- Prefer this skill when a structured operating pass will outperform a generic answer.

## Use when
- Use when an agent or prompt needs repeatable evaluation instead of anecdotal impressions.
- The main bottleneck is best solved through ai work rather than generic brainstorming.
- There is enough context to act, or the first useful move is to identify what is missing.

## Avoid when
- Do not declare quality from a handful of cherry-picked transcripts.
...
## Operating rules
- Evaluate behaviors that matter, not just style.
- Cover success, edge, and failure cases.
- Define score rules before reading results.
...
## Expanded workflow
1. Define the target behaviors and failure modes.
2. Write representative test cases and expected outcomes.
3. Set scoring rules and pass thresholds.
4. Return an eval plan with a lightweight maintenance loop.
...
## Example invocation
- Slash: `/ai_eval_harness <task>`
- Natural language: "Use aI Eval Harness to design test cases and score rules that catch regressions in agent quality and safety."
...
- Often paired with: `ai_prompt_system`, `ai_guardrail_review`

## Quality bar
- A good eval harness finds breakage early without becoming a research project.
