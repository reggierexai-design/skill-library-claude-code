...
## Purpose
- Define what an agent should remember, forget, summarize, or ask again over time.
...
## Use when
- Use when an agent will run repeatedly and needs stable memory boundaries.
- The main bottleneck is best solved through ai work rather than generic brainstorming.
- There is enough context to act, or the first useful move is to identify what is missing.

## Avoid when
- Do not use for one-shot tasks with no ongoing context.
...
## Example invocation
- Slash: `/ai_memory_policy <task>`
- Natural language: "Use aI Memory Policy to define what an agent should remember, forget, summarize, or ask again over time."
