...
# Engineering Feature Flag Rollout

## Purpose
- Design a staged feature-flag rollout with targeting, monitoring, and rollback criteria.
- This is an **engineering specialist** for Claude Code users who need a result that can survive review, handoff, or execution.
