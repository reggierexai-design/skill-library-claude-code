---
name: ai_prompt_regression_review
description: "Review prompt changes for behavior regressions, instruction conflicts, and hidden tradeoffs."
user-invocable: true
disable-model-invocation: true
---


# AI Prompt Regression Review

## Purpose
- Review prompt changes for behavior regressions, instruction conflicts, and hidden tradeoffs.
...
## Use when
- Use before or after changing system prompts, routing rules, or skill instructions.
- The main bottleneck is best solved through ai work rather than generic brainstorming.
- There is enough context to act, or the first useful move is to identify what is missing.

## Avoid when
- Do not use when prompt behavior has not materially changed.
...
## Example invocation
- Slash: `/ai_prompt_regression_review <task>`
- Natural language: "Use aI Prompt Regression Review to review prompt changes for behavior regressions, instruction conflicts, and hidden tradeoffs."
