...
## Operating rules
- Lead with the problem, promise, and next step fast.
- Sequence explanation, proof, differentiation, and call to action.
- Cut sections that do not move belief or action.
...
2. Audit the current story or create a new structure.
3. Write the section order, message points, and proof needs.
4. Return a draft or blueprint fit for implementation.
...
- Natural language: "Use landing Page Story to structure a landing page so attention converts into understanding, trust, and action."
...
## Quality bar
- A landing page wins when the right visitor knows what to do next.
