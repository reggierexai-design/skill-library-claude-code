...
## Use when
- Use when the user needs a multi-post thread for X or similar short-form platforms.
- The main bottleneck is best solved through attention work rather than generic brainstorming.
- There is enough context to act, or the first useful move is to identify what is missing.

## Avoid when
- Do not use when the idea is still weak and should be improved before formatting into a thread.
...
## Operating rules
- Lead with a hook that earns attention honestly.
- Deliver one clean argument or story arc.
- Every post should pull the reader to the next.
...
## Expanded workflow
1. Choose the central angle.
2. Write the hook, progression, and close.
3. Tighten for pace, clarity, and memorability.
4. Return the final thread plus optional variants.
...
- Natural language: "Use thread Writer to write social threads that teach, provoke, or persuade without sounding generic or inflated."
...
## Quality bar
- A good thread should feel worth sharing before it asks to be shared.
